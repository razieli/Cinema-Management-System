...
//		session.save(new Customer("Ron","Bonbon", hash("df38jed"), "RonBonbon", 0));
	...
	public void generateMovie() throws URISyntaxException {
		...
		session.save(new Movie("The Dark Knight","����� ����",2008,cast1s,152,13,description1, uri1a, uri1b,new GregorianCalendar(2010,5,27,0,00)));
		...
		session.save(new Movie("Inception","������",2010,cast2s,148,13,description2,uri2a, uri2b,new GregorianCalendar(2020,6,27,0,00)));
		...
		session.save(new Movie("Interstellar","��� ������",2014,cast3s,169,13,description3, uri3a, uri3b, new GregorianCalendar(2018,3,13,0,00)));
		...
		session.save(new Movie("Training Day","��� ������� �����",2001,cast4s,122,0,description4, uri4a, uri4b,new GregorianCalendar(2000,12,3,0,00)));
		...
		session.save(new Movie("The Lion King","��� ������",2019,cast5s,118,0,description5, uri5a, uri5b, new GregorianCalendar(2021,6,27,0,00)));
		...
		session.save(new Movie("The Pursuit of Happyness","���� �� �����",2006,cast5s,117,13,description6, uri6a, uri6b, new GregorianCalendar(18,3,27,0,00)));
		session.flush();
	}
